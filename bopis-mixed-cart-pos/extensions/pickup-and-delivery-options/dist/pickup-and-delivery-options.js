(() => {
  ...
  // extensions/pickup-and-delivery-options/src/PickupTile.jsx
  var import_react20 = __toESM(require_react());

  // node_modules/@remote-ui/rpc/build/esm/types.mjs
  var RETAIN_METHOD = Symbol.for("RemoteUi::Retain");
  var RELEASE_METHOD = Symbol.for("RemoteUi::Release");
  var RETAINED_BY = Symbol.for("RemoteUi::RetainedBy");
  ...
  function retainInternal(value, deep, seen) {
    ...
    if (deep) {
      if (Array.isArray(value)) {
        const nestedCanRetain = value.reduce((canRetain2, item) => retainInternal(item, deep, seen) || canRetain2, canRetain);
        seen.set(value, nestedCanRetain);
        return nestedCanRetain;
      }
      if (isBasicObject(value)) {
        const nestedCanRetain = Object.keys(value).reduce((canRetain2, key) => retainInternal(value[key], deep, seen) || canRetain2, canRetain);
        seen.set(value, nestedCanRetain);
        return nestedCanRetain;
      }
    }
  ...
  function releaseInternal(value, deep, seen) {
    ...
    if (deep) {
      if (Array.isArray(value)) {
        const nestedCanRelease = value.reduce((canRelease2, item) => releaseInternal(item, deep, seen) || canRelease2, canRelease);
        seen.set(value, nestedCanRelease);
        return nestedCanRelease;
      }
      if (isBasicObject(value)) {
        const nestedCanRelease = Object.keys(value).reduce((canRelease2, key) => releaseInternal(value[key], deep, seen) || canRelease2, canRelease);
        seen.set(value, nestedCanRelease);
        return nestedCanRelease;
      }
    }
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/point-of-sale/render/components/Dialog/Dialog.mjs
  var Dialog = createRemoteComponent("Dialog");

  // node_modules/@shopify/ui-extensions/build/esm/surfaces/point-of-sale/render/components/List/List.mjs
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/point-of-sale/render/components/RadioButtonList/RadioButtonList.mjs
  var RadioButtonList = createRemoteComponent("RadioButtonList");
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/point-of-sale/render/components/TextField/TextField.mjs
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/Dialog/Dialog.mjs
  var Dialog2 = createRemoteReactComponent(Dialog);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/List/List.mjs
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/RadioButtonList/RadioButtonList.mjs
  var RadioButtonList2 = createRemoteReactComponent(RadioButtonList);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/Stack/Stack.mjs
  var Stack2 = createRemoteReactComponent(Stack);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/Text/Text.mjs
  var Text2 = createRemoteReactComponent(Text);

  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/components/TextField/TextField.mjs
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/hooks/cart-api.mjs
  var import_react19 = __toESM(require_react(), 1);

  // node_modules/@remote-ui/async-subscription/build/esm/stateful.mjs
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/point-of-sale/hooks/cart-api.mjs
  var statefulSubscribable;
  var isCartApi = (api) => {
    return "cart" in api;
  };
  function useCartSubscription() {
    const statefulSubscribableCart = useStatefulSubscribableCart();
    const [cart, setCart] = (0, import_react19.useState)(statefulSubscribableCart.current);
    const unsubscribeRef = (0, import_react19.useRef)();
    (0, import_react19.useEffect)(() => {
      if (!unsubscribeRef.current) {
        statefulSubscribableCart.subscribe((cart2) => {
          setCart(cart2);
        });
      }
  ...
  var PickupTile_default = reactExtension("pos.home.tile.render", () => {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PickupTileComponent, {});
  });

  // extensions/pickup-and-delivery-options/src/Pickup.jsx
  var import_react21 = __toESM(require_react());
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var API_OMS_BASE_URL = "https://gorjana-uat.hotwax.io/api";
  var API_MAARG_BASE_URL = "https://gorjana-maarg-uat.hotwax.io/rest/s1";
  var Pickup = () => {
    const [selectedOption, setSelectedOption] = (0, import_react21.useState)("Ship");
    const [zipCode, setZipCode] = (0, import_react21.useState)("");
    const [zipCodeError, setZipCodeError] = (0, import_react21.useState)("");
    const [availableStores, setAvailableStores] = (0, import_react21.useState)([]);
    const [selectedStore, setSelectedStore] = (0, import_react21.useState)(null);
    const [selectedSKU, setSelectedSKU] = (0, import_react21.useState)(null);
    const [products, setProducts] = (0, import_react21.useState)({});
    const [loading, setLoading] = (0, import_react21.useState)(false);
    const [showNoStoresMessage, setShowNoStoresMessage] = (0, import_react21.useState)(false);
    const [dialogVisible, setDialogVisible] = (0, import_react21.useState)(false);
    const [dialogContent, setDialogContent] = (0, import_react21.useState)("");
    const api = useApi();
    const cart = useCartSubscription();
    (0, import_react21.useEffect)(() => {
      const variantIds = cart.lineItems.map((item) => item.variantId);
      const fetchProductVariants = () => __async(void 0, null, function* () {
        const results = yield api.productSearch.fetchProductVariantsWithIds(variantIds);
        const products2 = results.fetchedResources.reduce((acc, variant) => {
    ...
    const fetchStoresForSelectedSKU = (sku) => __async(void 0, null, function* () {
      if (!zipCode) {
      ...
      setLoading(true);
      try {
        const storeList = yield getAvailableStoresForSelectedSKU(zipCode, sku);
    ...
    const getAvailableStoresForSelectedSKU = (zipCode2, sku) => __async(void 0, null, function* () {
      try {
        const postcodeResponse = yield fetch(`${API_OMS_BASE_URL}/postcodeLookup`, {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            json: {
              query: `postcode:${zipCode2}`
            }
          })
        });
        const postcodeResult = yield postcodeResponse.json();
        const { latitude, longitude } = postcodeResult.response.docs[0];
        const storeResponse = yield fetch(`${API_OMS_BASE_URL}/storeLookup`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
        ...
        const storeResult = yield storeResponse.json();
        const stores = storeResult.response.docs.map((store) => ({
          label: `${store.storeName}`,
          value: store.storeCode,
          distance: `${Math.floor(Math.round(store.dist * 100) / 100 * 0.621371)} miles`
        }));
        const inventoryResponse = yield fetch(`${API_MAARG_BASE_URL}/ofbiz-oms-usl/checkBopisInventory`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
        ...
        const availableStores2 = stores.filter(
          (store) => inventoryByStore[store.value] && inventoryByStore[store.value][sku] > 0
        );
        const sortedStores = availableStores2.sort((a, b) => parseInt(a.distance, 10) - parseInt(b.distance, 10));
        return sortedStores;
      } catch (error) {
    ...
    const fetchStores = () => __async(void 0, null, function* () {
      if (!zipCode) {
        setZipCodeError("Zip code is required.");
        return;
      }
      ...
      try {
        ...
        const storeList = yield getAvailableStores(zipCode, skus, lineItems);
        setAvailableStores(storeList);
        if (storeList.length > 0) {
          setSelectedStore(storeList[0]);
        }
    ...
    function getAvailableStores(zipCode2, skus, lineItems) {
      return __async(this, null, function* () {
        try {
          const postcodeResponse = yield fetch(`${API_OMS_BASE_URL}/postcodeLookup`, {
            method: "POST",
          ...
          const availableStores2 = stores.filter(
            (store) => skus.every((sku) => {
              const lineItem = lineItems.find((item) => item.sku === sku);
              return inventoryByStore[store.value] && inventoryByStore[store.value][sku] >= (lineItem ? lineItem.quantity : 0);
            })
          );
          const sortedStores = availableStores2.sort((a, b) => parseInt(a.distance, 10) - parseInt(b.distance, 10));
          return sortedStores;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Navigator2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Screen2, { name: "DeliveryOptions", title: "Delivery Options", onNavigateBack: () => {
        api.navigation.dismiss();
      }, children: [
        cart.lineItems.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          Dialog2,
          {
            isVisible: true,
            title: "Cart is Empty",
          ...
          Stack2,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { variant: "headingLarge", children: "Select Delivery Option" }),
              selectedOption === "Ship" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                Button2,
                {
                  title: "Save",
                  type: "primary",
              ...
              selectedOption === "Store Pickup Together" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                Button2,
                {
                  title: "Proceed",
                  type: "primary",
              ...
              selectedOption === "Store Pickup Separate" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                Button2,
                {
                  title: "Proceed",
                  type: "primary",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ScrollView, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                RadioButtonList2,
                {
                  items: [
                    "Ship",
        ...
        dialogVisible && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          Dialog2,
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        Screen2,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ScrollView, { children: availableStores.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              RadioButtonList2,
              {
                items: availableStores.map((store) => `${store.label} (${store.distance})`),
                onItemSelected: (item) => {
                  const [label, distance] = item.split(" (");
                  const store = availableStores.find((store2) => store2.label === label);
                  setSelectedStore(store);
                },
                initialSelectedItem: selectedStore ? `${selectedStore.label} (${selectedStore.distance})` : null
              }
            ) : showNoStoresMessage && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextField2, { label: "No stores available for the entered zip code.", disabled: true }) }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              Button2,
              {
                title: "Save",
              ...
              List2,
              {
                ...
                data: cart.lineItems.map((item) => {
                  ...
                  return {
                    ...
                    leftSide: {
                      label: `SKU: ${item.sku}`,
                      image: { source: (_a = products[item.variantId]) == null ? void 0 : _a.image, badge: item.quantity },
                      subtitle: hasPickupStore ? [{ content: `Store: ${item.properties["Pick Up"]}`, color: "TextInteractive" }] : [{ content: "No Pickup Store Selected", color: "TextHighlist" }]
                    },
                    rightSide: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        Screen2,
        {
          ...
          children: [
            ...
            ) : showNoStoresMessage && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              TextField2,
              {
  ...
  var Pickup_default = reactExtension("pos.home.modal.render", () => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Pickup, {}));
})();
//# sourceMappingURL=pickup-and-delivery-options.js.map
